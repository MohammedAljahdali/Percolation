...
public class Percolation {
    ...
    public static void main(String[] args) {
        ...
        x.open(4,3);
        for (int i = 0, counter = 0; i < x.grid.length; i++) {
            for (int j = 0; j < x.grid.length; j++) {
        ...
        System.out.println("------------------");
        System.out.println(x.isFull(3,1));
        System.out.println("------------------");
        System.out.println(x.isFull(3,2));
        System.out.println("------------------");
        x.open(0,0);
        x.open(1,0);
        x.open(2,0);
